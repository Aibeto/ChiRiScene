...
> 最后更新位于此 head 之后：84d016f19f15884643046590912776bea94b4ba5
...
module/               # Magisk/KernelSU 模块载体（module.prop、customize.sh、service.sh）
  config/             # config.yaml / rules.yaml / i18n (en.ftl / zh.ftl)；<soc>/config.yaml + akmode.yaml 处理器子目录（各 SoC 自带，8450/8998 参数相同、各自一份）
